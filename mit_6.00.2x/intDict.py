...
class intDict(object):
    ...
    def __init__(self, numBuckets):
        ...
        for i in range(numBuckets):
            self.buckets.append([])
        #print("Just created dict with %i buckets" % len(self.buckets))
...
def main(hash_size, num_entries):
    hash_table = intDict(hash_size)
...
if __name__ == '__main__':
    ...
    main(hash_size, num_entries)
    print("Collision Prob = %f for hashsize = %i and entries = %i" % (collision_prob(hash_size, num_entries),hash_size, num_entries))
